...
class Projection(object):
    ...
    def show_image(self, new_pixels, img_name='img/projection.png', color=(0, 0, 255), alpha=0.4):
        """
...
if __name__ == "__main__":
    ...
    front_rgb = "img/front_view_path.png"
    top_rgb = "img/top_view_path.png"
    ...
    cv2.waitKey(0)
    cv2.imwrite('img/BEV_circle.png', img)
