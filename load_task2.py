...
def navigateAndSee(action=""):
    if action in action_names:
        ...
        num = 0
        path_rgb = "task2_data/"+floor+"/rgb/rgb_"+str(num)+".png"
        path_depth = "task2_data/"+floor+"/depth/depth_"+str(num)+".png"
        while(1):
...
while True:
    ...
    if keystroke == ord(FORWARD_KEY):
        ...
        with open('task2_data/'+floor+'/GT/GT.csv', 'a', newline='') as csvfile:
        ...
        shutil.rmtree("task2_data/"+floor+"/rgb")
        shutil.rmtree("task2_data/"+floor+"/depth")
        shutil.rmtree("task2_data/"+floor+"/GT")
        os.mkdir("task2_data/"+floor+"/rgb")
        os.mkdir("task2_data/"+floor+"/depth")
        os.mkdir("task2_data/"+floor+"/GT")
        GT = []
        print("omit all files from rgb and depth path")
    else:
        print("INVALID KEY")
        continue
